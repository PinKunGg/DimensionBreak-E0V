...
public class BossAI : MonoBehaviour
{
    ...
    [SerializeField] private GameObject BossGraphic;
    ...
    void Start()
    {
        ...
        seeker.StartPath(rb2d.position, Boss.GetPlayerGameObject.transform.position, OnPathComplete);
    ...
    void FixedUpdate()
    {
        ...
        disBetweenEnemyAndPlayer = Vector2.Distance(rb2d.position, Boss.GetPlayerGameObject.transform.position);
        ...
        else if (startWalk == true && isPlayerinRange == true)
        {
            ...
            //Rotate Graphic
            if (Boss.GetPlayerGameObject.transform.position.x > transform.position.x && TimeManager.GetTimeStop() == false)
            {
                BossGraphic.transform.localRotation = Quaternion.Euler(0f,180f,0f);
            }
            else if (Boss.GetPlayerGameObject.transform.position.x < transform.position.x && TimeManager.GetTimeStop() == false)
            {
                BossGraphic.transform.localRotation = Quaternion.Euler(0f,0f,0f);
            }
        }
    }
    ...
    {
        if(TimeManager.GetTimeStop() == false && Boss.GetisDamage == false)
        {
